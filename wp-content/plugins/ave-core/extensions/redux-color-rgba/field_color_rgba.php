    ...
    class ReduxFramework_color_rgba {
       ...
       */
        public function __construct( $field = array(), $value = '', $parent = '' ) {
            ...
            $this->field['options']['clickout_fires_change']   = isset($this->field['options']['clickout_fires_change']) ? $this->field['options']['clickout_fires_change'] : true;
        ...
        public function enqueue() {
            ...
            if (!wp_script_is ( 'redux-field-color-rgba-js' )) {
                wp_enqueue_script(
                    ...
                    plugin_dir_url( __FILE__ ) . '/field_color_rgba.min.js',
