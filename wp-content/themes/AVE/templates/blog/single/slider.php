			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<header class="entry-header blog-single-header">
						...
						<?php the_title( '<h1 class="blog-single-title entry-title h2" data-split-text="true" data-split-options=\'{ "type": "lines" }\' data-fittext="true" data-fittext-options=\'{ "maxFontSize": "currentFontSize" }\'>', '</h1>' ); ?>				
	...
	<div class="row">
		...
		<?php do_action( 'liquid_start_single_post_container' ); ?>
			...
			<article class="blog-single">
				...
				<?php if( 'liquid-header' === get_post_type() || 
